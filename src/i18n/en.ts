...
// Flashcard Settings
    ...
    "Open context memory": "Open context memory",
    "Local context recommendations update while you type. AI refinement only runs when you select it.": "Local context recommendations update while you type. AI refinement only runs when you select it.",
    "AI refine context": "AI refine context",
    "Open a Markdown note to see contextual highlights.": "Open a Markdown note to see contextual highlights.",
    "Finding context locally…": "Finding context locally…",
    "Showing {count} local context recommendations.": "Showing {count} local context recommendations.",
    "Context recommendations failed: {error}": "Context recommendations failed: {error}",
    "AI is refining the current context…": "AI is refining the current context…",
    "Showing {count} AI context recommendations.": "Showing {count} AI context recommendations.",
    "AI context refinement failed: {error}": "AI context refinement failed: {error}",
